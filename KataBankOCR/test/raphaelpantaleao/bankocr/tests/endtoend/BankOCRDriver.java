...
import static com.github.raphaelpanta.katabankocr.constants.Constants.APP_NAME;
import static com.github.raphaelpanta.katabankocr.constants.Constants.FILE_CHOOSER_NAME;
...
public class BankOCRDriver extends JFrameDriver {
    ...
    private static final ComponentSelector<JFrame> topLevelFrame = topLevelFrame(
	    named(APP_NAME), showingOnScreen());
